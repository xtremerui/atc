...
type FakeVolumeFactory struct {
	...
	FindResourceCacheVolumeStub        func(db.Worker, *db.UsedResourceCache) (db.CreatedVolume, bool, error)
...
func (fake *FakeVolumeFactory) FindResourceCacheVolume(arg1 db.Worker, arg2 *db.UsedResourceCache) (db.CreatedVolume, bool, error) {
