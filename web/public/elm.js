...
var _concourse$atc$Concourse_Pagination$parseLinkTuple = function (header) {
	...
	if (_p10.ctor === '[]') {
		...
		if ((((_p11.ctor === '::') && (_p11._0.ctor === 'Just')) && (_p11._1.ctor === '::')) && (_p11._1._0.ctor === 'Just')) {
			return _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple2', _0: _p11._1._0._0, _1: _p11._0._0});
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	}
...
var _concourse$atc$Concourse_Pagination$parsePagination = F2(
	function (decode, response) {
		...
		if (_p14.ctor === 'Err') {
			...
			return _elm_lang$core$Task$succeed(
				{content: _p14._0, pagination: pagination});
		}
	});
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							steps: _elm_lang$core$Basics$not(
								_concourse$atc$Concourse_BuildStatus$isRunning(_p5)) ? A2(
								_elm_lang$core$Maybe$map,
								_concourse$atc$StepTree$update(_concourse$atc$StepTree$Finished),
								model.steps) : model.steps,
							buildStatus: _elm_lang$core$Maybe$Just(
...
var _concourse$atc$BuildOutput$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {build: a, steps: b, errors: c, state: d, eventSourceOpened: e, events: f, buildStatus: g};
	});
...
var _concourse$atc$BuildOutput$handleEventsAction = F2(
	function (action, model) {
		...
		switch (_p6.ctor) {
			...
			case 'Event':
				if (_p6._0.ctor === 'Ok') {
					return A2(_concourse$atc$BuildOutput$handleEvent, _p6._0._0, model);
				} else {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_elm_lang$core$Debug$log, _p6._0._0, _elm_lang$core$Platform_Cmd$none)
					};
				}
			default:
				return {
...
var _concourse$atc$BuildOutput$init = function (build) {
	...
	var model = {build: build, steps: _elm_lang$core$Maybe$Nothing, errors: _elm_lang$core$Maybe$Nothing, state: outputState, events: _elm_lang$core$Platform_Sub$none, eventSourceOpened: false, buildStatus: _elm_lang$core$Maybe$Nothing};
...
var _concourse$atc$Concourse_Job$url = function (job) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'/teams/',
		A2(
...
var _concourse$atc$Concourse_Job$Job = F6(
	function (a, b, c, d, e, f) {
		return {name: a, teamName: b, pipelineName: c, finishedBuild: d, paused: e, disableManualTrigger: f};
	});

var _concourse$atc$Build$getJobName = function (_p0) {
	return A2(
		_elm_lang$core$Maybe$map,
		function (_) {
			return _.name;
...
var _concourse$atc$Build$getPipelineName = function (_p1) {
	return A2(
		_elm_lang$core$Maybe$map,
		function (_) {
...
var _concourse$atc$Build$viewDetailItem = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
...
var _concourse$atc$Build$viewBuildPrepInput = function (_p6) {
	var _p7 = _p6;
	return A3(
		_concourse$atc$Build$viewBuildPrepLi,
		A2(_elm_lang$core$Basics_ops['++'], 'discovering any new versions of ', _p7._0),
		_p7._1,
		_elm_lang$core$Dict$empty);
};
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A3(_concourse$atc$Build$viewBuildPrepLi, 'checking pipeline is not paused', _p9.pausedPipeline, _elm_lang$core$Dict$empty),
										A3(_concourse$atc$Build$viewBuildPrepLi, 'checking job is not paused', _p9.pausedJob, _elm_lang$core$Dict$empty)
									]),
								A2(
									_elm_lang$core$Basics_ops['++'],
									_concourse$atc$Build$viewBuildPrepInputs(_p9.inputs),
									_elm_lang$core$Native_List.fromArray(
										[
											A3(_concourse$atc$Build$viewBuildPrepLi, 'waiting for a suitable set of input versions', _p9.inputsSatisfied, _p9.missingInputReasons),
											A3(_concourse$atc$Build$viewBuildPrepLi, 'checking max-in-flight is not reached', _p9.maxRunningBuilds, _elm_lang$core$Dict$empty)
										]))))
						]))
				]));
	} else {
...
var _concourse$atc$Build$updateStartFinishAt = F3(
	function (status, date, info) {
			...
			return _elm_lang$core$Native_Utils.update(
				info,
				{
					duration: _elm_lang$core$Native_Utils.update(
						duration,
						{
							startedAt: _elm_lang$core$Maybe$Just(date)
						})
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				info,
				{
					duration: _elm_lang$core$Native_Utils.update(
						duration,
						{
							finishedAt: _elm_lang$core$Maybe$Just(date)
						})
				});
		}
	});
...
var _concourse$atc$Build$CurrentBuild = F5(
	function (a, b, c, d, e) {
		return {build: a, prep: b, status: c, duration: d, output: e};
	});
...
var _concourse$atc$Build$BuildStatus = F2(
	function (a, b) {
		return {ctor: 'BuildStatus', _0: a, _1: b};
	});
...
var _concourse$atc$Build$handleBuildFetched = F2(
	function (build, model) {
		...
		var currentBuild = {build: build, status: build.status, duration: build.duration, prep: _elm_lang$core$Maybe$Nothing, output: _elm_lang$core$Maybe$Nothing};
...
var _concourse$atc$Build$viewHistoryItem = F3(
	function (currentBuild, currentStatus, build) {
		return A2(
			_elm_lang$html$Html$li,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.eq(build.name, currentBuild.name) ? _concourse$atc$Concourse_BuildStatus$show(currentStatus) : _concourse$atc$Concourse_BuildStatus$show(build.status),
							_1: true
						},
							{
							ctor: '_Tuple2',
...
var _concourse$atc$Build$viewHistory = F3(
	function (currentBuild, currentStatus, builds) {
		return A2(
			_elm_lang$html$Html$ul,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			A2(
				_elm_lang$core$List$map,
				A2(_concourse$atc$Build$viewHistoryItem, currentBuild, currentStatus),
				builds));
	});
var _concourse$atc$Build$lazyViewHistory = F3(
	function (currentBuild, currentStatus, builds) {
		return A4(_elm_lang$html$Html_Lazy$lazy3, _concourse$atc$Build$viewHistory, currentBuild, currentStatus, builds);
	});
var _concourse$atc$Build$viewBuildHeader = F2(
	function (currentBuild, _p26) {
		var _p27 = _p26;
		var _p32 = _p27.job;
		var buildTitle = function () {
			var _p28 = currentBuild.build.job;
			if (_p28.ctor === 'Just') {
				var _p29 = _p28._0.name;
				return A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_p28._0.pipelineName,
											A2(_elm_lang$core$Basics_ops['++'], '/jobs/', _p29))))))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								_p29,
								A2(_elm_lang$core$Basics_ops['++'], ' #', currentBuild.build.name)))
						]));
			} else {
				return _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'build #',
						_elm_lang$core$Basics$toString(currentBuild.build.id)));
			}
		}();
		var abortButton = _concourse$atc$Concourse_BuildStatus$isRunning(currentBuild.status) ? A2(
			_elm_lang$html$Html$span,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('build-action build-action-abort fr'),
					_elm_lang$html$Html_Events$onClick(
					_concourse$atc$Build$AbortBuild(currentBuild.build.id)),
			...
			if (_p30.ctor === 'Just') {
				var buttonDisabled = function () {
					...
					if (_p31.ctor === 'Nothing') {
						...
						return _p31._0.disableManualTrigger;
					}
				}();
				var actionUrl = A2(
					_elm_lang$core$Basics_ops['++'],
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'/jobs/',
									A2(_elm_lang$core$Basics_ops['++'], _p30._0.name, '/builds'))))));
				return A2(
					_elm_lang$html$Html$form,
					_elm_lang$core$Native_List.fromArray(
						[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[buildTitle])),
							A2(_concourse$atc$BuildDuration$view, currentBuild.duration, _p27.now)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A3(_concourse$atc$Build$lazyViewHistory, currentBuild.build, currentBuild.status, _p27.history)
						]))
				]));
	});
var _concourse$atc$Build$view = function (model) {
	var _p33 = model.currentBuild;
	if (_p33.ctor === 'Just') {
		var _p37 = _p33._0;
		return A2(
			_elm_lang$html$Html$div,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_concourse$atc$Build$viewBuildHeader, _p37, model),
					A2(
					_elm_lang$html$Html$div,
					A2(
						_elm_lang$core$List_ops['::'],
						_elm_lang$html$Html_Attributes$id('build-body'),
						_concourse$atc$Build$paddingClass(_p37.build)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Native_List.fromArray(
							[
								_concourse$atc$Build$viewBuildPrep(_p37.prep),
								A2(_elm_lang$html$Html_Lazy$lazy, _concourse$atc$Build$viewBuildOutput, _p37.output)
							]),
						function () {
							var maybeBirthDate = _elm_lang$core$Maybe$oneOf(
								_elm_lang$core$Native_List.fromArray(
									[_p37.duration.startedAt, _p37.duration.finishedAt]));
							var _p34 = {ctor: '_Tuple2', _0: maybeBirthDate, _1: _p37.build.reapTime};
							if (((_p34.ctor === '_Tuple2') && (_p34._0.ctor === 'Just')) && (_p34._1.ctor === 'Just')) {
								return _elm_lang$core$Native_List.fromArray(
									[
										A2(
										_elm_lang$html$Html$div,
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														A2(
															...
															'build #',
															function () {
																var _p35 = _p37.build.job;
																if (_p35.ctor === 'Nothing') {
																	return _elm_lang$core$Basics$toString(_p37.build.id);
																} else {
																	return _p37.build.name;
																}
															}()))
													])),
												A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															_concourse$atc$Build$mmDDYY(_p34._0._0),
															A2(
																_elm_lang$core$Basics_ops['++'],
																'-',
																_concourse$atc$Build$mmDDYY(_p34._1._0))))
													])),
												A2(
												_elm_lang$html$Html$div,
												_elm_lang$core$Native_List.fromArray(
...
var _concourse$atc$Build$scrollBuilds = function (delta) {
	return function (_p38) {
		return A2(
			...
			A3(_elm_lang$core$Task$perform, _elm_lang$core$Result$Err, _elm_lang$core$Result$Ok, _p38));
	}(
		A2(_concourse$atc$Scroll$scroll, 'builds', delta));
};
var _concourse$atc$Build$scrollToCurrentBuildInHistory = function (_p39) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_elm_lang$core$Basics$always(_concourse$atc$Build$Noop),
		...
		switch (_p41.ctor) {
			...
			case 'FetchBuild':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_concourse$atc$Build$fetchBuild, 0, _p41._0)
				};
			case 'BuildFetched':
				if (_p41._0.ctor === 'Ok') {
					return A2(_concourse$atc$Build$handleBuildFetched, _p41._0._0, model);
				} else {
					return A2(
						_elm_lang$core$Debug$log,
						A2(
							...
							_elm_lang$core$Basics$toString(_p41._0._0)),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				}
			case 'AbortBuild':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _concourse$atc$Build$abortBuild(_p41._0)
				};
			case 'BuildAborted':
				if (_p41._0.ctor === 'Ok') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					if ((_p41._0._0.ctor === 'BadResponse') && (_p41._0._0._0 === 401)) {
						return {
							ctor: '_Tuple2',
							_0: model,
			...
			case 'BuildPrepFetched':
				if (_p41._0.ctor === 'Ok') {
					return A2(_concourse$atc$Build$handleBuildPrepFetched, _p41._0._0, model);
				} else {
					return A2(
						_elm_lang$core$Debug$log,
						A2(
			...
			case 'BuildOutputAction':
				...
				if (((_p42.ctor === '_Tuple2') && (_p42._0.ctor === 'Just')) && (_p42._1.ctor === 'Just')) {
					var _p43 = A2(_concourse$atc$BuildOutput$update, _p41._0, _p42._1._0);
					var newOutput = _p43._0;
					var cmd = _p43._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentBuild: A2(
								...
								function (info) {
									return A3(
										_concourse$atc$Build$updateStartFinishAt,
										_p45,
										_p41._1,
										_concourse$atc$Concourse_BuildStatus$isRunning(info.status) ? _elm_lang$core$Native_Utils.update(
											info,
											{status: _p45}) : info);
								},
								model.currentBuild)
			...
			case 'BuildHistoryFetched':
				if (_p41._0.ctor === 'Err') {
					...
					return A2(_concourse$atc$Build$handleHistoryFetched, _p41._0._0, model);
				}
			case 'BuildJobDetailsFetched':
				if (_p41._0.ctor === 'Ok') {
					return A2(_concourse$atc$Build$handleBuildJobFetched, _p41._0._0, model);
				} else {
					return A2(
						_elm_lang$core$Debug$log,
						A2(
			...
			case 'ScrollBuilds':
				if (_p41._0._0 === 0) {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _concourse$atc$Build$scrollBuilds(_p41._0._1)
					};
				} else {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _concourse$atc$Build$scrollBuilds(0 - _p41._0._0)
					};
				}
			default:
				return {
...
var _concourse$atc$Navigation$Model = F4(
	function (a, b, c, d) {
		return {subModel: a, currentState: b, pipelines: c, jobs: d};
	});
var _concourse$atc$Navigation$PipelinesFetched = function (a) {
	return {ctor: 'PipelinesFetched', _0: a};
};
var _concourse$atc$Navigation$fetchPipelines = function (_p0) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
...
var _concourse$atc$Navigation$init = F2(
	function (currentState, _p1) {
		var _p2 = _p1;
		return {
			ctor: '_Tuple2',
			_0: A4(
				_concourse$atc$Navigation$Model,
				_p2._0,
				currentState,
				_elm_lang$core$Native_List.fromArray(
					[]),
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$core$Platform_Cmd$map, _concourse$atc$Navigation$SubAction, _p2._1),
						_concourse$atc$Navigation$fetchPipelines
					]))
		};
	});
var _concourse$atc$Navigation$update = F3(
	function (subUpdate, action, model) {
		var _p3 = action;
		if (_p3.ctor === 'SubAction') {
			var _p4 = A2(subUpdate, _p3._0, model.subModel);
			var subModel = _p4._0;
			var subCmd = _p4._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{subModel: subModel}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _concourse$atc$Navigation$SubAction, subCmd)
			};
		} else {
			if (_p3._0.ctor === 'Err') {
				return A2(
...
var _concourse$atc$Navigation$view = F2(
	function (subView, model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('nav-page')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('nav-sidebar')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('magic-search')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
							...
							function () {
							var _p5 = model.currentState.job;
							if (_p5.ctor === 'Nothing') {
								return _elm_lang$html$Html$text('i aint got NOOOO nav for you, boy');
							} else {
								var _p6 = _p5._0;
								return A2(
									_elm_lang$html$Html$div,
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('events')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('event build started')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html_Attributes$class('event-header')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$class('fa fa-hashtag started')
																]),
															_elm_lang$core$Native_List.fromArray(
																[])),
															A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$href(
																	_concourse$atc$Concourse_Job$url(_p6))
																]),
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html$text(
																	A2(_elm_lang$core$Basics_ops['++'], _p6.name, ' #23'))
																]))
														])),
													A2(
													_elm_lang$html$Html$div,
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html_Attributes$class('event-body build-info')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															A2(
																...
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('started')
																				])),
																			A2(
																			_elm_lang$html$Html$td,
																			_elm_lang$core$Native_List.fromArray(
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('5 minutes ago')
																				]))
																		])),
																	A2(
																	_elm_lang$html$Html$tr,
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('5 minutes')
																				]))
																		]))
																]))
														]))
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('event resource')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$class('fa fa-cube')
																]),
															_elm_lang$core$Native_List.fromArray(
																[])),
															A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html$text('concourse')
																]))
														])),
													A2(
													_elm_lang$html$Html$div,
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html_Attributes$class('event-body resource-info')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															A2(
																...
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('0fd4d2a444584fdb949fc99548a7bda604c9e368')
																				]))
																		]))
																]))
														]))
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('event build failed')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$class('fa fa-hashtag failed')
																]),
															_elm_lang$core$Native_List.fromArray(
																[])),
															A2(
																...
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('9 minutes ago')
																				]))
																		])),
																	A2(
																	_elm_lang$html$Html$tr,
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('4 minutes')
																				]))
																		]))
																]))
														]))
																...
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('1.2.0')
																				]))
																		]))
																]))
														]))
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('event build succeeded')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$class('fa fa-hashtag succeeded')
																]),
															_elm_lang$core$Native_List.fromArray(
																[])),
															A2(
																...
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('succeeded')
																				])),
																			A2(
																			_elm_lang$html$Html$td,
																			_elm_lang$core$Native_List.fromArray(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('event build aborted')
												]),
											_elm_lang$core$Native_List.fromArray(
												[
													A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$html$Html_Attributes$class('fa fa-hashtag aborted')
																]),
															_elm_lang$core$Native_List.fromArray(
																[])),
															A2(
																...
																[
																	...
																	_elm_lang$core$Native_List.fromArray(
																		[
																			...
																			_elm_lang$core$Native_List.fromArray(
																				[
																					_elm_lang$html$Html$text('aborted')
																				])),
																			A2(
																			_elm_lang$html$Html$td,
																			_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('nav-content')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
...
var _concourse$atc$BuildPage$init = function (flags) {
	return A2(
		_concourse$atc$Navigation$init,
		flags.navState,
		A2(
			_concourse$atc$Autoscroll$init,
			_concourse$atc$Build$getScrollBehavior,
			_concourse$atc$Build$init(flags.buildFlags)));
};
var _concourse$atc$BuildPage$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _concourse$atc$BuildPage$init,
			update: _concourse$atc$Navigation$update(
				_concourse$atc$Autoscroll$update(_concourse$atc$Build$update)),
			view: _concourse$atc$Navigation$view(
				_concourse$atc$Autoscroll$view(_concourse$atc$Build$view)),
			subscriptions: function () {
				var tick = A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _concourse$atc$Build$ClockTick);
				var pushDown = A2(
					_elm_lang$core$Time$every,
									...
									_elm_lang$core$Platform_Sub$batch(
										_elm_lang$core$Native_List.fromArray(
											[
												...
												var _p0 = A2(
													_elm_lang$core$Maybe$andThen,
													model.subModel.subModel.currentBuild,
													function (_) {
														return _.output;
													});
												if (_p0.ctor === 'Nothing') {
													...
													return A2(_elm_lang$core$Platform_Sub$map, _concourse$atc$Build$BuildOutputAction, _p0._0.events);
												}
											}()
											])))
								])));
	...
	flags: A2(
		...
		function (buildFlags) {
			return A2(
												...
												return A2(
													...
													function (pipelineName) {
														return A2(
															...
															function (teamName) {
																return _elm_lang$core$Json_Decode$succeed(
																	{name: name, pipelineName: pipelineName, teamName: teamName});
															});
													});
											}))
									]))),
				...
				function (navState) {
					return _elm_lang$core$Json_Decode$succeed(
						{buildFlags: buildFlags, navState: navState});
				});
		})
};
var _concourse$atc$BuildPage$Flags = F2(
	function (a, b) {
		return {navState: a, buildFlags: b};
	});
