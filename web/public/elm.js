...
var _concourse$atc$Navigation$iconForStatus = function (status) {
	var _p0 = status;
	switch (_p0) {
		case 'failed':
			return 'fa-close';
...
var _concourse$atc$Navigation$buildEvent = F2(
	function (status, pct) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'event', _1: true},
							{ctor: '_Tuple2', _0: 'build', _1: true},
							{ctor: '_Tuple2', _0: status, _1: true}
						]))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('build')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('#306')
								])),
							A2(
							_elm_lang$html$Html$span,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('hl')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('testflight')
								]))
						])),
					A2(
					_elm_lang$html$Html$div,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('fg'),
									_elm_lang$html$Html_Attributes$style(
									_elm_lang$core$Native_List.fromArray(
										[
											{
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(
													A2(_elm_lang$core$Basics$min, pct, 100)),
												'%')
										}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('glyph')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														'fa ',
														_concourse$atc$Navigation$iconForStatus(status)))
												]),
											_elm_lang$core$Native_List.fromArray(
												[]))
										]))
								])),
							(_elm_lang$core$Native_Utils.cmp(pct, 100) > 0) ? A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('over'),
									_elm_lang$html$Html_Attributes$style(
									_elm_lang$core$Native_List.fromArray(
										[
											{
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(pct - 100),
												'%')
										}
										]))
								]),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('not-over-lol')
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						]))
...
var _concourse$atc$Navigation$startedBuild = _concourse$atc$Navigation$buildEvent('started');
var _concourse$atc$Navigation$failedBuild = _concourse$atc$Navigation$buildEvent('failed');
...
var _concourse$atc$Navigation$fetchPipelines = function (_p1) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_concourse$atc$Navigation$PipelinesFetched,
		A3(_elm_lang$core$Task$perform, _elm_lang$core$Result$Err, _elm_lang$core$Result$Ok, _p1));
}(
	...
	function (currentState, _p2) {
		...
		return {
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$core$Platform_Cmd$map, _concourse$atc$Navigation$SubAction, _p3._1),
...
var _concourse$atc$Navigation$update = F3(
	function (subUpdate, action, model) {
		var _p4 = action;
		if (_p4.ctor === 'SubAction') {
			var _p5 = A2(subUpdate, _p4._0, model.subModel);
			var subModel = _p5._0;
			var subCmd = _p5._1;
			return {
				ctor: '_Tuple2',
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('nav-radar')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_concourse$atc$Navigation$failedBuild(1),
							_concourse$atc$Navigation$failedBuild(8),
							_concourse$atc$Navigation$failedBuild(54),
							_concourse$atc$Navigation$failedBuild(99),
							_concourse$atc$Navigation$failedBuild(182),
							_concourse$atc$Navigation$startedBuild(34),
							_concourse$atc$Navigation$startedBuild(68),
							_concourse$atc$Navigation$startedBuild(96),
							_concourse$atc$Navigation$startedBuild(110)
						]))
				]));
	});
